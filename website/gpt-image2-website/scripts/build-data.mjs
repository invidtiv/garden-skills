...
const CATEGORY_META = {
  'ui-mockups': { label: 'UI Mockups', cn: 'UI Mockups', accent: '#1F6FB2' },
  'product-visuals': { label: 'Product Visuals', cn: 'Product Visuals', accent: '#C7522A' },
  'maps': { label: 'Maps', cn: 'Maps', accent: '#3B7A57' },
  'slides-and-visual-docs': { label: 'Slides & Docs', cn: 'Visual Docs', accent: '#6A4C93' },
  'poster-and-campaigns': { label: 'Posters & Campaigns', cn: 'Posters', accent: '#E8472C' },
  'portraits-and-characters': { label: 'Portraits', cn: 'Portraits', accent: '#8B4513' },
  'scenes-and-illustrations': { label: 'Scenes', cn: 'Scenes', accent: '#5E8B7E' },
  'editing-workflows': { label: 'Editing', cn: 'Editing', accent: '#4A6FA5' },
  'avatars-and-profile': { label: 'Avatars', cn: 'Avatars', accent: '#D08C60' },
  'storyboards-and-sequences': { label: 'Storyboards', cn: 'Storyboards', accent: '#A23E48' },
  'grids-and-collages': { label: 'Grids & Collages', cn: 'Collages', accent: '#2E7D8B' },
  'branding-and-packaging': { label: 'Branding', cn: 'Branding', accent: '#B8860B' },
  'typography-and-text-layout': { label: 'Typography', cn: 'Typography', accent: '#4F4F4F' },
  'assets-and-props': { label: 'Assets & Props', cn: 'Assets', accent: '#6B5B95' },
  'academic-figures': { label: 'Academic', cn: 'Academic', accent: '#1A4E8A' },
  'infographics': { label: 'Infographics', cn: 'Infographics', accent: '#D4665A' },
  'technical-diagrams': { label: 'Technical Diagrams', cn: 'Technical', accent: '#0A6E96' },
};
